        ...
        <div class= "bg_cyan-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
             ...
             <div class="sm:w-1/2 px-16" >
                ...
                <form action="../controller/registrationController.php" method="POST" class="flex flex-col gap-4">
                    <input class="p-2 mt-8 round-x1 border rounded-xl" type="text" name="fullname" placeholder="Full Name">
                    <input class="p-2 mt-1 round-x1 border rounded-xl" type="text" name="email" placeholder="Email">
                    ...
                    <div class="mt-5">
                        <input type="checkbox" class="border-gray-400" name="" id="">
                        <span>
                ...
                <div class="mt-3 text-xs flex justif-between items-center">
                    ...
                    <button class="'py-2 px-5 bg-yellow-400 border rounded-xl">Login</button>
                </div> 
