...
<body class="font-sans bg-gray-100">
  ...
  <div class="container mx-auto mt-8 p-4 flex">
    ...
    <div class="w-4/5 p-4">
      ...
      <form class="max-w-md mx-auto border-spacing-2">
        ...
        <div class="mb-4">
          ...
          <input type="text" placeholder="Email" id="name" name="name" class="w-full border p-2 rounded-md">
        </div>
        <div class="mb-4">
      
          <input type="text" placeholder="Password" id="name" name="name" class="w-full border p-2 rounded-md">
        </div>
        <div class="mb-4">
        
          <input type="text" placeholder="Expericence" id="name" name="name" class="w-full border p-2 rounded-md">
        </div>
        <div class="mb-4">
        
        <input type="text" placeholder="Expertise" id="name" name="name" class="w-full border p-2 rounded-md">
      </div>
      <div class="mb-4">
        
        <button class="bg-[#FEB600] pl-3 pr-3 pb-2 pt-2">Add instructor</button>
      </div>
